...
(function (global, factory) {
  ...
  SmoothDnD__default.wrapChild = function (p) { return p; }; // don't wrap children they will already be wrapped
  ...
  var Container = {
    ...
    mounted: function mounted () {
      ...
      this.container = SmoothDnD__default(this.containerElement, mapOptions(this));
    },
